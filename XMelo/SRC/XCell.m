...
- (void)layoutSubviews {
    ...
    self.nameLabel.frame = CGRectMake(self.headView.right + 10, 10, (kScreenWidth - self.headView.width - 60)/2, 20);
    
    self.introLabel.frame = CGRectMake(self.nameLabel.left, self.nameLabel.bottom + 5, self.nameLabel.width, 20);
}
